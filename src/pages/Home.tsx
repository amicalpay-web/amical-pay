...
function Home() {
  return (
    <>
      <SeoHead
        title="Recharge Free Fire, Steam, PlayStation, Xbox & Roblox"
        description="Rechargez vos Diamonds Free Fire, cartes Steam, PlayStation, Xbox, Roblox et plus, en gourdes (HTG) ou USD. Paiement MonCash/PayPal, livraison rapide, support WhatsApp 24/7."
        path="/"
      />
