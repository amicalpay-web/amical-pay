...
export function validateConfig(): void {
  ...
  if (NODE_ENV === 'production' && (!getEnv('SUPABASE_URL') || !getEnv('SUPABASE_SERVICE_ROLE_KEY'))) {
    console.warn('⚠️ Supabase server credentials are not fully configured; authenticated orders will remain unavailable')
  }
}
